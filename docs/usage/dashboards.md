...
To get started, simply enroll your OpenCTI platform following the instructions in our Enrollment documentation here: XXX (this documentation is on the XTM Hub project).

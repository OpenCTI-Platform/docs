...
To set your ingestion parameters, click on the red button in the bottom right-hand corner with a white cross in the center.
...
- finally, enter a user responsible for data creation (if the field is left blank it will automatically be stamped ‘empty’).

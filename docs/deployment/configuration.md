...
| file_index_manager:lock_key         | FILE_INDEX_MANAGER__LOCK_KEY                     | file_index_manager_lock    | Lock key for the manager in Redis                   |
| file_index_manager:interval         | FILE_INDEX_MANAGER__INTERVAL                     | 6000                       | Interval to check new files                         |
!!! note "Default file"

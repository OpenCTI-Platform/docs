...
| app:notifier_authorized_functions                    | APP__NOTIFIER_AUTHORIZED_FUNCTIONS                     | ["if", "for", "while", "stringify", "Date", "toLocaleString"] | Authorized function that wan be used in webhook templates           |
